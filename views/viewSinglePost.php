                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <textarea name="content" rows="2" class="text-area-messge form-control"
                                    placeholder="Entrez votre commentaire" aria-required="true" aria-invalid="false"
                                    required></textarea>
                            </div>
                            <div class="col-sm-12">
                                <button class="submit-btn" type="submit" id="form-submit"><b>POSTER UN
                ...
                <div class="commnets-area text-left">
                    ...
                    <div class="comment">
                        <div class="post-info">
                            ...
                            <div class="middle-area">
                                <a class="name"
                                    href="#"><b><?= $comment['firstName'] .' '. $comment['lastName'] ?></b></a>
